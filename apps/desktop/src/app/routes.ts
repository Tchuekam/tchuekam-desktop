...
export const IMAGE_STUDIO_ROUTE = '/image-studio'
...
export const APP_ROUTES = [
  ...
  { id: 'assistants', path: ASSISTANTS_ROUTE, view: 'assistants' },
  { id: 'image-studio', path: IMAGE_STUDIO_ROUTE, view: 'image-studio' }
