...
export class HermesGateway extends JsonRpcGatewayClient {
  constructor() {
    super({
      closedErrorMessage: 'TchuekaM gateway connection closed',
      connectErrorMessage: 'Could not connect to TchuekaM gateway',
      createRequestId: nextId => nextId,
      notConnectedErrorMessage: 'TchuekaM gateway is not connected',
